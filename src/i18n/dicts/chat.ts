...
export const chat = defineDict({
  es: {
    ...
    visualReport: 'Generar informe visual',
    viewVisualReport: 'Ver informe visual',
    liveDrawing: 'Dibujando en vivo…',
    preview: 'Vista previa',
    codeTab: 'Código',
    fullscreen: 'Pantalla completa',
    interactiveHtml: 'Informe Visual / HTML',
    ...
    toolsHeader: '{count} llamadas a herramientas',
    toolsHeaderSingle: '1 llamada a herramienta',
    toolsHeaderRunning: 'Ejecutando herramientas…',
    toolsHeaderWebSearch: '{count} búsquedas en la web',
    toolsHeaderWebSearchSingle: '1 búsqueda en la web',
    toggleTools: 'Alternar llamadas a herramientas',
  ...
  en: {
    ...
    visualReport: 'Generate visual report',
    viewVisualReport: 'View visual report',
    liveDrawing: 'Drawing live…',
    preview: 'Preview',
    codeTab: 'Code',
    fullscreen: 'Fullscreen',
    interactiveHtml: 'Visual Report / HTML',
    ...
    toolDurationMs: '{ms} ms',
    toolDurationSeconds: '{seconds} s',
    toolsHeader: '{count} tool calls',
    toolsHeaderSingle: '1 tool call',
    toolsHeaderRunning: 'Running tools…',
    toolsHeaderWebSearch: '{count} web searches',
    toolsHeaderWebSearchSingle: '1 web search',
    toggleTools: 'Toggle tool calls',
